                    ...
                    <div className="card action-trigger-hover border bg-transparent">
                      ...
                      <div className="card-body pb-0">
                        ...
                        <h5 className="card-title">
                          <a href="#">
                           Complete Study Materials With Table
                          </a>
                        </h5>
                        ...
                        <div className="d-flex justify-content-between mb-2">
                          ...
                          <div className="hstack gap-2">
                            <p className="h6 fw-light mb-0 m-0"></p>
                            <span className="small">(Buy 2 get 3)</span>
                          </div>
                        </div>
                ...
                <div className="row mt-0 mt-xl-5">
                    ...
                    <div className="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                      ...
                      <blockquote>
                        <p>
                          ...
                          ShopCart is a Leadin Top E-commerce agreeable
                  ...
                  <div className="col-md-5 mt-5 mt-md-0 d-none d-md-block">
                    <div className="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                      ...
                      <h6 className="mb-3">100+ Verified Suppliers</h6>
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div className="ms-2">
                          ...
                          <p className="mb-0 small">Supplier of Electronics</p>
                        </div>
                      </div>
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <div className="ms-2">
                          ...
                          <p className="mb-0 small">Supplier of Clothing</p>
                        </div>
                      </div>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">
                          ...
                          <p className="mb-0 small">Supplier of Kids Sections</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-body shadow text-center p-4 rounded-3">
                      ...
                      <blockquote>
                        <p>
                          ...
                          At weddings believed laughing although the ShopCart    
