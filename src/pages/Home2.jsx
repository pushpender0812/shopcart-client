...
const Home2 = () => {
  ...
  return (
	...
	<section className="position-relative overflow-hidden pt-5 pt-lg-3" style={{ margin: "0 auto", width: "fit-content" }}>
...
<section>
      <div className="container">
        ...
        <ul className="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
          <li className="nav-item me-2 me-sm-5">
            <button
              className={`nav-link mb-2 mb-md-0 ${!selectedCategory ? 'active' : ''}`}
						...
						<div>
							<div className="card action-trigger-hover border bg-transparent">
								...
								<div className="card-body pb-0">
									...
									<div className="hstack gap-3">
										<span className="h6 fw-light mb-0"><i className="far fa-clock text-danger me-2"></i>24h 56m</span>
										<span className="h6 fw-light mb-0"><i className="fas fa-table text-orange me-2"></i>55 lectures</span>
									</div>
								</div>
						...
						<div>
							<div className="card action-trigger-hover border bg-transparent">
								...
								<div className="card-body pb-0">
									...
									<div className="hstack gap-3">
										<span className="h6 fw-light mb-0"><i className="far fa-clock text-danger me-2"></i>09h 56m</span>
										<span className="h6 fw-light mb-0"><i className="fas fa-table text-orange me-2"></i>21 lectures</span>
									</div>
								</div>
